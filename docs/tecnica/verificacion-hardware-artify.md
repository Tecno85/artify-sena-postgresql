...
| --- | --- |
| Capacidad de procesamiento | Que el servidor pueda ejecutar Node.js, Express y consultas hacia MySQL sin degradación evidente. |
...
| Sistema operativo | Que sea compatible con Node.js, pnpm, MySQL y herramientas de administración. |
...
| --- | --- | --- |
| Procesador | 2 vCPU | Permite ejecutar Node.js, Express y tareas básicas de MySQL para un uso moderado. |
...
| Sistema operativo | Linux servidor, Windows Server o macOS compatible | Debe permitir instalar Node.js, pnpm, MySQL y herramientas de administración. |
...
| Memoria RAM | 4 GB | Da mayor margen para MySQL, Node.js, sistema operativo y procesos auxiliares. |
...
| MySQL | Almacena usuarios, sesiones, configuraciones, imágenes y operaciones. |
...
Para un entorno de producción también considero importante mantener actualizado el sistema operativo, proteger credenciales, configurar el servicio del backend y revisar que MySQL esté correctamente inicializado con la estructura de base de datos del proyecto.
...
| Backend a base de datos | Conexión desde Node.js hacia MySQL. |
...
| MySQL | Base de datos con opciones de licencia; se debe revisar la edición usada. |
...
- MySQL Documentation. Documentación oficial de MySQL y sus opciones de instalación.
